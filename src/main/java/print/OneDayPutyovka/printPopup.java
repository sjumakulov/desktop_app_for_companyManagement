...
import static print.OneDayPutyovka.backPage.backPage;
import static print.OneDayPutyovka.frontPage.frontPage;
...
public class printPopup {
    ...
    public static void showOneDayPrintPopup(MouseEvent e, String ID, Connection connection) {
        ...
        jDialog(FRAME, ID, connection);
        glassPane.setVisible(false);

    }

    public static JDialog jDialog(JFrame FRAME, String ID, Connection connection) {
        ...
        jd.getContentPane().add(printDialog(jd, ID, connection), BorderLayout.CENTER);
        jd.setVisible(true);

        return jd;
    }

    public static JPanel printDialog(JDialog jd, String ID, Connection connection) {
        ...
        if (ID.isBlank()) {
            printDialog.add(backPage(), gbc);
        } else {
            printDialog.add(frontPage(ID, connection), gbc);
        }
